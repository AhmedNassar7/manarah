...
const EN: Dictionary = {
  ...
  "quranReader.playAyah": "Play verse {ayah}",

  "quranAudioPlayer.play": "Play",
  "quranAudioPlayer.pause": "Pause",
  "quranAudioPlayer.previous": "Previous verse",
  "quranAudioPlayer.next": "Next verse",
  "quranAudioPlayer.stop": "Stop",
  "quranAudioPlayer.idle": "Select a verse to play",
  "quranAudioPlayer.nowPlaying": "Verse {ayah}",
  "quranAudioPlayer.reciter": "Reciter",
  "quranAudioPlayer.repeat": "Repeat",
  "quranAudioPlayer.speed": "Speed",

  "reciter.alafasy": "Mishary Alafasy",
  "reciter.abdul-basit": "Abdul Basit Abdul Samad",
  "reciter.sudais": "Abdul Rahman Al-Sudais",
  "reciter.shuraym": "Saud Al-Shuraim",
  "reciter.husary": "Mahmoud Khalil Al-Husary",
  "reciter.minshawy": "Mohamed Siddiq Al-Minshawi",
  "reciter.maher-almuaiqly": "Maher Al Muaiqly",
  "reciter.muhammad-ayyoub": "Muhammad Ayyoub",
  "reciter.abdullah-basfar": "Abdullah Basfar",
  "reciter.yasser-dussary": "Yasser Al-Dosari",
...
const AR: Dictionary = {
  ...
  "quranReader.playAyah": "تشغيل الآية {ayah}",

  "quranAudioPlayer.play": "تشغيل",
  "quranAudioPlayer.pause": "إيقاف مؤقت",
  "quranAudioPlayer.previous": "الآية السابقة",
  "quranAudioPlayer.next": "الآية التالية",
  "quranAudioPlayer.stop": "إيقاف",
  "quranAudioPlayer.idle": "اختر آية للتشغيل",
  "quranAudioPlayer.nowPlaying": "الآية {ayah}",
  "quranAudioPlayer.reciter": "القارئ",
  "quranAudioPlayer.repeat": "التكرار",
  "quranAudioPlayer.speed": "السرعة",

  "reciter.alafasy": "مشاري راشد العفاسي",
  "reciter.abdul-basit": "عبد الباسط عبد الصمد",
  "reciter.sudais": "عبدالرحمن السديس",
  "reciter.shuraym": "سعود الشريم",
  "reciter.husary": "محمود خليل الحصري",
  "reciter.minshawy": "محمد صديق المنشاوي",
  "reciter.maher-almuaiqly": "ماهر المعيقلي",
  "reciter.muhammad-ayyoub": "محمد أيوب",
  "reciter.abdullah-basfar": "عبدالله بصفر",
  "reciter.yasser-dussary": "ياسر الدوسري",
